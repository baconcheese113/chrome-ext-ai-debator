...
export function narratorSeed(config: RunConfig, participantNames: string[]): string {
  return [
    ...
    '```json',
    '{',
    '  "plainSummary": "<what happened this round, for a curious 12-year-old>",',
    ...
    '',
    'ABOUT "plainSummary"',
    'Three or four sentences a curious 12-year-old could follow. No jargon — if a term is',
    'unavoidable, explain it in the same breath. Name who did what, using the participant',
    'names. Say what actually changed this round, not what the topic is about. Everything',
    'else in the JSON stays as technical as it needs to be; only this field is plain.',
    '',
    'Good: "Grok said nothing can come from nothing. Kimi pointed out that saying nothing is',
    '\'unstable\' already treats it like a thing, which is the very idea being argued for.',
    'Grok agreed and dropped that line."',
    'Bad: "The panel explored foundational questions and made progress."',
    '',
